...
import com.example.uua2.utils.WebUtils;
...
public class PigDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		String grantType = paramMap.get(OAuth2ParameterNames.GRANT_TYPE)[0];
		String clientId = paramMap.get(OAuth2ParameterNames.CLIENT_ID)[0];
